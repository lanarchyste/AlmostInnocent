...
namespace Almost_Innocent.Scenarios
{
    public class Scenario2 : BaseScenario, IScenario
    {
        ...
        public Scenario2(bool isAIEnabled, bool isGameStartWithClues, int totalSurveyTokens, int numberSurveyTokens, int cardSurveyTokens, int almostInnocentTokens)
            : base(new ScenarioBoard2(), _cardTypes, _regexQuestion, null, isAIEnabled, isGameStartWithClues, totalSurveyTokens, numberSurveyTokens, cardSurveyTokens, almostInnocentTokens)
        {
