...
namespace Almost_Innocent.Scenarios
{
    ...
    {
		public Scenario3(bool isIAEnabled, bool isGameStartWwithClues, int totalSurveyTokens, int numberSurveyTokens, int cardSurveyTokens, int almostInnocentTokens)
            : base(new ScenarioBoard3(), new("^(#|V|VICTIME |BLEU |P|PREUVE |VERT |L|LIEU |ORANGE |CR|CRIME |JAUNE ){1}[A-F1-6]{1}$"), isIAEnabled, isGameStartWwithClues, totalSurveyTokens, numberSurveyTokens, cardSurveyTokens, almostInnocentTokens)
        {
        ...
        private static Scenario3 Create(DIFFICULTY_LEVEL level, bool isIAEnabled, bool isGameStartWwithClues)
            => level switch
            {
                DIFFICULTY_LEVEL.DETECTIVE => new Scenario3(isIAEnabled, isGameStartWwithClues, 8, 5, 3, 0),
                DIFFICULTY_LEVEL.MEDIUM => new Scenario3(isIAEnabled, isGameStartWwithClues, 9, 6, 3, 1),
                _ => new Scenario3(isIAEnabled, isGameStartWwithClues, 12, 9, 3, 2),
            };
    }
}
