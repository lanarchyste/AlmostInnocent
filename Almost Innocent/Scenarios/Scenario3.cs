...
namespace Almost_Innocent.Scenarios
{
    public class Scenario3 : BaseScenario, IScenario
    {
        ...
        public Scenario3(bool isAIEnabled, bool isGameStartWwithClues, int totalSurveyTokens, int numberSurveyTokens, int cardSurveyTokens, int almostInnocentTokens)
            : base(new ScenarioBoard3(), _cardTypes, _regexQuestion, null, isAIEnabled, isGameStartWwithClues, totalSurveyTokens, numberSurveyTokens, cardSurveyTokens, almostInnocentTokens)
        {
        ...
        private static Scenario3 Create(DIFFICULTY_LEVEL level, bool isAIEnabled, bool isGameStartWwithClues)
            => level switch
            {
                DIFFICULTY_LEVEL.DETECTIVE => new Scenario3(isAIEnabled, isGameStartWwithClues, 8, 5, 3, 0),
                DIFFICULTY_LEVEL.MEDIUM => new Scenario3(isAIEnabled, isGameStartWwithClues, 9, 6, 3, 1),
                _ => new Scenario3(isAIEnabled, isGameStartWwithClues, 12, 9, 3, 2),
            };
    }
}
