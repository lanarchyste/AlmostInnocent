...
namespace Almost_Innocent.Scenarios
{
    public class Scenario3 : BaseScenario, IScenario
    {
        ...
        private Scenario3(bool isAIEnabled, bool isGameStartWithClues, int totalSurveyTokens, int numberSurveyTokens, int cardSurveyTokens, int almostInnocentTokens)
            : base(new ScenarioBoard3(), ScenarioCardTypes, RegexQuestion, null, isAIEnabled, isGameStartWithClues, totalSurveyTokens, numberSurveyTokens, cardSurveyTokens, almostInnocentTokens)
        {
        ...
        private static Scenario3 Create(DIFFICULTY_LEVEL level, bool isAIEnabled, bool isGameStartWithClues)
            => level switch
            {
                DIFFICULTY_LEVEL.DETECTIVE => new Scenario3(isAIEnabled, isGameStartWithClues, 8, 5, 3, 0),
                DIFFICULTY_LEVEL.MEDIUM => new Scenario3(isAIEnabled, isGameStartWithClues, 9, 6, 3, 1),
                _ => new Scenario3(isAIEnabled, isGameStartWithClues, 12, 9, 3, 2),
            };
    }
}
