...
namespace Almost_Innocent.Scenarios
{
    public class Scenario5 : BaseScenario, IScenario
    {
        ...
        private Scenario5(bool isAIEnabled, bool isGameStartWithClues, int totalSurveyTokens, int numberSurveyTokens, int cardSurveyTokens, int almostInnocentTokens)
            : base(new ScenarioBoard5(), ScenarioCardTypes, RegexQuestion, null, isAIEnabled, isGameStartWithClues, totalSurveyTokens, numberSurveyTokens, cardSurveyTokens, almostInnocentTokens)
        {
        ...
        private static Scenario5 Create(DIFFICULTY_LEVEL level, bool isAIEnabled, bool isGameStartWithClues)
            => level switch
            {
                DIFFICULTY_LEVEL.DETECTIVE => new Scenario5(isAIEnabled, isGameStartWithClues, 10, 7, 3, 0),
                DIFFICULTY_LEVEL.MEDIUM => new Scenario5(isAIEnabled, isGameStartWithClues, 11, 8, 3, 1),
                _ => new Scenario5(isAIEnabled, isGameStartWithClues, 12, 9, 3, 2),
            };
    }
}
