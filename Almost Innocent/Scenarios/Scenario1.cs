...
namespace Almost_Innocent.Scenarios
{
    public class Scenario1 : BaseScenario, IScenario
    {
        ...
        private Scenario1(bool isAIEnabled, bool isGameStartWithClues, int totalSurveyTokens, int almostInnocentTokens)
            : base(new ScenarioBoard1(), ScenarioCardTypes, RegexQuestion, null, isAIEnabled, isGameStartWithClues, totalSurveyTokens, totalSurveyTokens, totalSurveyTokens, almostInnocentTokens)
        {
