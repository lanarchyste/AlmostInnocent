...
namespace Almost_Innocent.Scenarios
{
    public class Scenario6 : BaseScenario, IScenario
    {
        ...
        public Scenario6(bool isAIEnabled, bool isGameStartWwithClues, int totalSurveyTokens, int numberSurveyTokens, int cardSurveyTokens, int almostInnocentTokens)
            : base(new ScenarioBoard6(), _cardTypes, _regexQuestion, null, isAIEnabled, isGameStartWwithClues, totalSurveyTokens, numberSurveyTokens, cardSurveyTokens, almostInnocentTokens)
        {
        ...
        private static Scenario6 Create(DIFFICULTY_LEVEL level, bool isAIEnabled, bool isGameStartWwithClues)
            => level switch
            {
                DIFFICULTY_LEVEL.DETECTIVE => new Scenario6(isAIEnabled, isGameStartWwithClues, 9, 7, 2, 0),
                DIFFICULTY_LEVEL.MEDIUM => new Scenario6(isAIEnabled, isGameStartWwithClues, 10, 8, 2, 1),
                _ => new Scenario6(isAIEnabled, isGameStartWwithClues, 12, 9, 3, 2),
            };
    }
}
