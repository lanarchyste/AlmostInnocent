...
namespace Almost_Innocent.Scenarios
{
    public class Scenario6 : BaseScenario, IScenario
    {
        ...
        public Scenario6(bool isAIEnabled, bool isGameStartWithClues, int totalSurveyTokens, int numberSurveyTokens, int cardSurveyTokens, int almostInnocentTokens)
            : base(new ScenarioBoard6(), _cardTypes, _regexQuestion, null, isAIEnabled, isGameStartWithClues, totalSurveyTokens, numberSurveyTokens, cardSurveyTokens, almostInnocentTokens)
        {
